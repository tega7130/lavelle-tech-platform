...
// The 17-permission catalogue, six categories — README "Permissions" table.
...
// them; only PERMISSIONS.map(...) (all 17, for Super Admin) does.
const { VIEW_CANDIDATES, EDIT_CANDIDATES, VIEW_CONTACT_REQUESTS, RESOLVE_CONTACT_REQUESTS, ADD_ADMIN_NOTES, VIEW_PAYMENTS, MANAGE_PAYMENTS, VIEW_GRADES, GRADE_ASSESSMENTS, MANAGE_PROGRAMMES, MANAGE_INTAKES, ISSUE_CERTIFICATES, VIEW_AUDIT_LOG, EXPORT_DATA } = Permission;
...
export const ROLE_PRESETS: Record<StaffRole, Permission[]> = {
  ...
  ACADEMIC_ADMIN: [
    VIEW_CANDIDATES, VIEW_GRADES, GRADE_ASSESSMENTS, MANAGE_PROGRAMMES, MANAGE_INTAKES,
