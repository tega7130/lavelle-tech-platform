...
async function seedDocument(staffId: string, categoryId: string, overrides: Partial<{ title: string; priceMinor: number; isActive: boolean; deletedAt: Date | null; description: string | null }> = {}) {
